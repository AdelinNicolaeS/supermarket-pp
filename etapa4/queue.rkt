...
(define (enqueue x q)
  (if (>= (queue-size-l q) (+ 1 (queue-size-r q)))
      ...
      (struct-copy queue q [left (rotate (queue-left q) (cons x (queue-right q)) null)] [size-l (+ (queue-size-l q) (queue-size-r q) 1)] [right '()] [size-r 0])))
...
(define (dequeue q)
  (if (>= (- (queue-size-l q) 1) (queue-size-r q))
      ...
      (struct-copy queue q [left (rotate (stream-rest (queue-left q)) (queue-right q) null)] [size-l (+ (- (queue-size-l q) 1)  (queue-size-r q))] [right '()] [size-r 0])))
